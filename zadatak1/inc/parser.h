...
switch (yytype)
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YY_ASSERT (tok == token::TOK_END || tok == token::TOK_PLUS || tok == token::TOK_STAR || tok == token::TOK_LPAREN || tok == token::TOK_RPAREN || tok == token::TOK_COLON || tok == token::TOK_COMMA || tok == token::TOK_DOLAR || tok == token::TOK_PERCENT || tok == token::TOK_GLOBAL || tok == token::TOK_EXTERN || tok == token::TOK_SECTION || tok == token::TOK_EQU || tok == 282);
      }
#else
      ...
      {
        YY_ASSERT (tok == token::TOK_DECIMAL || tok == token::TOK_HEX);
      }
#else
      ...
      symbol_type (int tok, std::string v, location_type l)
        : super_type(token_type (tok), std::move (v), std::move (l))
      {
        YY_ASSERT (tok == token::TOK_WORD || tok == token::TOK_SKIP || tok == token::TOK_SYMBOL || tok == token::TOK_REG || tok == token::TOK_EMPTYINS || tok == token::TOK_JMPINS || tok == token::TOK_ONEINS || tok == token::TOK_TWOINS || tok == token::TOK_LDRSTRINS || tok == token::TOK_NOTINS);
      }
#else
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_DOLAR (location_type l)
      {
        return symbol_type (token::TOK_DOLAR, std::move (l));
      }
#else
      static
      symbol_type
      make_DOLAR (const location_type& l)
      {
        return symbol_type (token::TOK_DOLAR, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_DECIMAL (int v, location_type l)
      {
      ...
      static
      symbol_type
      make_DECIMAL (const int& v, const location_type& l)
      {
      ...
      static
      symbol_type
      make_EMPTYINS (std::string v, location_type l)
      {
        return symbol_type (token::TOK_EMPTYINS, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_EMPTYINS (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TOK_EMPTYINS, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_JMPINS (std::string v, location_type l)
      {
        return symbol_type (token::TOK_JMPINS, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_JMPINS (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TOK_JMPINS, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_ONEINS (std::string v, location_type l)
      {
        return symbol_type (token::TOK_ONEINS, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_ONEINS (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TOK_ONEINS, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_TWOINS (std::string v, location_type l)
      {
        return symbol_type (token::TOK_TWOINS, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_TWOINS (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TOK_TWOINS, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_LDRSTRINS (std::string v, location_type l)
      {
        return symbol_type (token::TOK_LDRSTRINS, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_LDRSTRINS (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TOK_LDRSTRINS, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_NOTINS (std::string v, location_type l)
      {
        return symbol_type (token::TOK_NOTINS, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_NOTINS (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TOK_NOTINS, v, l);
      }
#endif
